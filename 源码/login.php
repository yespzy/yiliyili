...
if(!empty($_POST['sub'])){
	...
	if(is_array($result)){
		...
		echo "<script>alert('登陆成功');location.href='backstage.php';</script>";
	}else{
    ...
    <div class="bodyer" style="box-shadow: #777 1px 1px 3px;">
        <div class="box_login" align="center" style="box-shadow: #777 1px 1px 1px;">
    		...
    		<h2>请YiliYili管理员账号登录！</h2>
                ...
                <div class="form-group">
                    <label for="password" class="col-sm-2 control-label">密&nbsp&nbsp&nbsp码</label>
                    <div class="col-sm-10">
